...
try:
    ...
    try:
        with open(LOGFILE, "w") as _f:
            _f.write("timestamp_iso8601,counter,tempC,pressure_hPa,humidity_pct_or_-1,last_ack_rssi_or_nan\n")
    except Exception:
...
while True:
    ...
    # CSV output only: counter, tempC, pressure_hPa, humidity_pct_or_-1, last_ack_rssi_or_nan
